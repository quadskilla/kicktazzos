...
const FRAME_DIR = path.join(ROOT_DIR, "frames");
const CHROME_PORT = 9336;
const FPS = 30;
const DURATION = 13.5;
const TOTAL_FRAMES = Math.round(FPS * DURATION);
const OUTPUT = path.join(OUT_DIR, "tazzo-strike-mobile-ad.mp4");
const CHROME_PATHS = [
...
function launchChrome() {
  const profileDir = path.join(ROOT_DIR, ".chrome-frames-profile");
